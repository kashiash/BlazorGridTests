...
namespace BlazorGridTests.Module.DatabaseUpdate;
...
public class Updater : ModuleUpdater {
    ...
    public override void UpdateDatabaseAfterUpdateSchema() {
      ...
      //  AddSoupAndNuts(ObjectSpace);
        ObjectSpace.CommitChanges(); //This line persists created object(s).
    }

    private void AddSoupAndNuts(IObjectSpace objectSpace)
    {
        var prodFaker = new Faker<SoupToNut>("pl")

.CustomInstantiator(f => ObjectSpace.CreateObject<SoupToNut>())
    .RuleFor(o => o.SomeString, f => f.Commerce.ProductName())
    .RuleFor(o => o.SomeNotes, f => f.Commerce.ProductDescription())
    .RuleFor(o => o.AnotherString, f => f.Commerce.Product())
    .RuleFor(o => o.SomeDecimal, f => f.Random.Decimal(0.01M, 100M))
    .RuleFor(o => o.OnceMoreString, f => f.Commerce.Ean13())
 .RuleFor(o => o.SomeBoolean, f => f.Random.Bool())
  .RuleFor(o => o.Somedate, f => f.Date.Past(1))
 ;
